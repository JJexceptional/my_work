...
def play_music():
    ...
    for num, song in enumerate(songs):
        ...
        pygame.mixer.music.queue(root.directory + "/" + song)

    print("play_music - done")

def pause_music():
    global pause
    pygame.mixer.music.pause()
    pause = True
    print("pause_music - done")
...
def next_music():
    ...
    try:
        ...
        current_song = songs[songlist.curselection()[0]]
        play_music()
        print("next_music - done")
    except:
        print("next_music - exception")
        pass
...
def prev_music():
    ...
    try:
        ...
        current_song = songs[songlist.curselection()[0]]
        play_music()
        print("prev_music - done")
    except:
        print("prev_music - exception")
        pass
