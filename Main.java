...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        if (action == '+') {
            ...
            int multiplier = Integer.parseInt(data[1]); // узнать по integer and parseInt
            String result = "";
            ...
            if (index == -1) {
                ...
                String result = data[0].substring(0, index); // разобраться полностью в выполнении действий вычетания и
                                                             // деления
